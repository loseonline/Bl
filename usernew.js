...
// @downloadURL  https://github.com/loseonline/Bl/raw/main/usernew.js
// @updateURL    https://github.com/loseonline/Bl/raw/main/usernew.js
...
try {
	...
	settingsMenu.appendChild(createSettingElement('Yonca Atlama (%)', 'flowerSkipPercentage', 'range', 0, 100, 1,
		...
		'TR: Yüzde olarak bir yoncanın eksik olma olasılığı.'));
	settingsMenu.appendChild(createSettingElement('Min Buz Vuruşları', 'minIceHits', 'range', 1, 10, 1,
		'EN: Minimum number of clicks per freeze.<br>' +
		'TR: Buz minimum tıklama sayısı.'));
	settingsMenu.appendChild(createSettingElement('Min Bomba Patlatma', 'minBombHits', 'range', 0, 10, 1,
		'EN: Minimum number of clicks per bomb.<br>' +
		'TR: Bir bombanın minimum tıklama sayısı.'));
	...
	settingsMenu.appendChild(createSettingElement('Maksimum Gecikme (ms)', 'maxDelayMs', 'range', 10, 10000, 10,
		...
		'TR: Tıklamalar arasındaki maksimum gecikme.'));
	settingsMenu.appendChild(createSettingElement('Otomatik Oynat', 'autoClickPlay', 'checkbox', null, null, null,
		'EN: Automatically start the next game at the end of.<br>' +
		'TR: Bitirdiğinizde bir sonraki oyunu otomatik olarak başlatın.'));

	const pauseResumeButton = document.createElement('button');
	pauseResumeButton.textContent = 'Durakla';
  ...
  `;
	...
	function toggleGamePause() {
		...
		pauseResumeButton.textContent = isGamePaused ? 'Sürdür' : 'Durakla';
