...
try {
	...
	settingsMenu.appendChild(createSettingElement('Minimum Dondurma Vuruşları', 'minIceHits', 'range', 1, 10, 1,
		'TR: Dondurma başına minimum tıklama sayısı.<br>' +
		'EN: Minimum number of clicks to freeze.'));
	settingsMenu.appendChild(createSettingElement('Minimum Bomba Vuruşu', 'minBombHits', 'range', 0, 10, 1,
		'TR: Bomba başına minimum tıklama sayısı.<br>' +
		'EN: Minimum number of clicks per bomb.'));
	settingsMenu.appendChild(createSettingElement('Minimum Gecikme (ms)', 'minDelayMs', 'range', 10, 10000, 10,
	...
	settingsMenu.appendChild(createSettingElement('Otomatik Tıklama', 'autoClickPlay', 'checkbox', null, null, null,
