...
try {
	...
	settingsMenu.appendChild(createSettingElement('Yonca Atlama (%)', 'flowerSkipPercentage', 'range', 0, 100, 1,
		'TR: Bir yoncayı atlamanın yüzdelik olasılığı.<br>' +
		'EN: Flower Missing Probability in Percentage.'));
	settingsMenu.appendChild(createSettingElement('Min Buz Vuruşu', 'minIceHits', 'range', 1, 10, 1,
		'TR: Dondurma başına minimum tıklama sayısı.<br>' +
		'EN: Minimum number of clicks to freeze.'));
	settingsMenu.appendChild(createSettingElement('En Az Bomba Vuruşu', 'minBombHits', 'range', 0, 10, 1,
		'TR: Bomba başına minimum tıklama sayısı.<br>' +
		'EN: Minimum number of clicks per bomb.'));
	settingsMenu.appendChild(createSettingElement('Min Gecikme (ms)', 'minDelayMs', 'range', 10, 10000, 10,
		'TR: Tıklamalar arasındaki minimum gecikme.<br>' +
		'EN: Minimal delay between clicks.'));
	settingsMenu.appendChild(createSettingElement('Maksimum Gecikme (ms)', 'maxDelayMs', 'range', 10, 10000, 10,
		'TR: Tıklamalar arasındaki maksimum gecikme.<br>' +
		'EN: Maximum delay between clicks.'));
	settingsMenu.appendChild(createSettingElement('Oto Oyna', 'autoClickPlay', 'checkbox', null, null, null,
		'TR: Oyunun sonunda otomatik olarak bir sonraki oyuna başla.<br>' +
'EN: Automatically start next game after finishing.'));
	...
	githubButton.href = 'https://github.com/loseonline/Bl';
